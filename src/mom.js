...
const mom=()=>{
    return<div style={{ width:"100%", height:"100vh" , textAlign:"center" ,backgroundImage: `url(${LogoImage})` , backgroundRepeat:"no-repeat", backgroundSize:"Cover", backgroundPosition: "center"}}>
